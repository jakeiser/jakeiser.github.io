...
This course aims to help students develop a working knowledge of literary forms and methods pertinent to exegesis of the New Testament. Toward that end, the course is divided into weekly modules, each of which focuses on a representative text from the four major genres of the New Testament: Gospels, Acts, Epistles, and Apocalypses. These modules are futher subdivided into 50-minute workshops and two-hour discussion sections. The workshops will involve practical exercises designed to acquaint students with key disciplines, tools, and methods for the study of the New Testament. Students will apply the insights gained from these exercises to weekly exegetical reports. In turn, these reports will provide a starting point for our discussion of critical issues raised by the text for the week. With some exceptions, the texts follow the schedule of readings in the <i>Revised Common Lectionary.
