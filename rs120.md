...
This course<!--excerpt.start--> offers an introduction to the origins of Christianity, the Bible, and the major Christian traditions. The course is divided into three units covering the biblical foundations of Christianity, medieval developments, and modern challenges. Topics to be covered include heresy and orthodoxy, church and state, the relationship between science and religion.<!--excerpt.end-->. This study will be conducted academically, so no particular religious affiliation is presumed or necessary.
